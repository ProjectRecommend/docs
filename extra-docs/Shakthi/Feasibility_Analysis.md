# **Feasibility Analysis For Project Recommend**
...
## Scope of Document
This document covers the technical as well as the economic aspects of "Project Recommend"
...
There are many websites that provide users with online recommendation of Music but there are hardly any solving the same problem offline.

Here are few limitations of all those online Music recommendation that we are trying to overcome
- Collaborative Filtering Recommendations require continuous use of their services to get approximately correct recommendations.
...
- We plan to provide recommendations on your offline music collection.
...
Through this method the user data is taken for the recommendations of next set of songs.  But, due to lack of time and resources we do not have enough user data to make this method feasible to use.

- Waveform Analysis  
In this method, we analyze and classify
...
##### Survey of 110 odd people, belonging to different sectors such as corporate, business etc. and belonging to different age groups has been taken. Given below is a list of questions we asked in our survey, and their corresponding responses, represented in the form of pie-charts.   
